...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`fixed bottom-20 right-4 w-72 bg-bgPrimary p-4 rounded-xl shadow-lg z-50 chatbot ${
          ...
          {showPricingMessage && (
            <>
              <p className="bg-white text-bgPrimary font-semibold rounded my-2 p-1">
                If you need more information about our pricing please reach out
                to us on WhatsApp.
              </p>
              <button
                onClick={() => {
