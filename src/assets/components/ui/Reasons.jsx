  ...
  return (
    <div className="relative w-[95vw] lg:w-[300px] h-[450px] overflow-hidden rounded-lg shadow-lg">
      <img
        ...
        loading="lazy"
      />
      <div className="absolute bottom-0 w-full h-[200px] bg-primary bg-opacity-90 p-4 flex flex-col items-center justify-center text-center text-white">
        <p className="text-4xl mb-2 text-white">{icon}</p>
